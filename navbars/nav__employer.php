  ...
  <div class="container-fluid">
    <nav class="navbar navbar-expand-lg custom_nav-container ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
              <a class="nav-link" href="#" onclick="ALERT()"> Dashboard</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="#" onclick="ALERT()"> <i class="fa fa-plus-circle" aria-hidden="true"></i> New Job</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="#" onclick="ALERT()">Job List</a>
          </li>
